  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      localeResolutionCallback:
        ...
        debugPrint(
            "locale: 4locale   sups: 4supportedLocales  currentLocale: 4{model.currentLocale}");
        if (model.currentLocale == locale) return model.currentLocale;
        for (var supportedLocale in supportedLocales) {
          if (supportedLocale == locale) {
            model.currentLocale = locale ?? const Locale('en', 'US');
      ...
      localeListResolutionCallback:
        ...
        debugPrint("locatassss: 4locales  sups: 4supportedLocales");
        return model.currentLocale;
      },
