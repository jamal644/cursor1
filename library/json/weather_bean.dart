...
class HeWeather6ListBean {
  ...
  static HeWeather6ListBean fromMap(Map<String, dynamic> map) {
    HeWeather6ListBean heWeather6ListBean = HeWeather6ListBean();
    heWeather6ListBean.status = map['status'] ?? '';
    heWeather6ListBean.basic =
        map['basic'] != null ? BasicBean.fromMap(map['basic']) : null;
    heWeather6ListBean.now =
        map['now'] != null ? NowBean.fromMap(map['now']) : null;
    heWeather6ListBean.update =
        map['update'] != null ? UpdateBean.fromMap(map['update']) : null;
