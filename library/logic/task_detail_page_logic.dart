...
class TaskDetailPageLogic {
  ...
  Color getTextColor(BuildContext context) {
    ...
    final color = ColorBean.fromBean(textColor);
    return color ?? Theme.of(context).colorScheme.onBackground;
  }
  ...
  void exitPage({bool isDeleting = false}) {
    ...
    if (needUpdate && !isDeleting) {
      ...
      DBProvider.db.updateTask(_model.taskBean).then((value) async {
        ...
        if (_model.doneTaskPageModel?.logic != null) {
    ...
    showDialog(
        ...
        builder: (ctx) {
          return NetLoadingWidget(
              loadingController: _model.globalModel.loadingController);
        });
